...
describe('Badge Component Contract Tests', () => {
  describe('Basic Rendering', () => {
    it('should render a badge element', () => {
      ...
      const badge = getBadgeElement('Badge content');
    ...
    it('should render children content', () => {
      ...
      const badge = getBadgeElement('New');
  ...
  describe('Sizes', () => {
    it('should render default size when no size is specified', () => {
      ...
      const badge = getBadgeElement('Default Size');
    ...
    it('should render xs size', () => {
      ...
      const badge = getBadgeElement('Extra Small');
  ...
  describe('States', () => {
    it('should be enabled by default', () => {
      ...
      const badge = getBadgeElement('Enabled Badge');
    ...
    it('should show loading state when loading prop is true', () => {
      ...
      const badge = getBadgeElement('Loading Badge');
    ...
    it('should show selected state when selected prop is true', () => {
      ...
      const badge = getBadgeElement('Selected Badge');
  ...
  describe('Accessibility Attributes', () => {
    ...
    it('should support aria-labelledby for label reference', () => {
      ...
      const badge = getBadgeElement('Active');
    ...
    it('should support aria-live for dynamic content', () => {
      ...
      const badge = getBadgeElement('Live Badge');
    ...
    it('should support aria-atomic for atomic updates', () => {
      ...
      const badge = getBadgeElement('Atomic Badge');
  ...
  describe('Counter Functionality', () => {
    it('should display numeric values', () => {
      ...
      const badge = getBadgeElement('42');
      expect(badge).toBeInTheDocument();
    });
    ...
    it('should support max value display', () => {
      ...
      const badge = getBadgeElement('99+');
      expect(badge).toBeInTheDocument();
    });
    ...
    it('should show exact count when below max', () => {
      ...
      const badge = getBadgeElement('85');
      expect(badge).toBeInTheDocument();
    });
    ...
    it('should support custom overflow text', () => {
      ...
      const badge = getBadgeElement('99many');
      expect(badge).toBeInTheDocument();
    });
  });
  ...
  describe('Status Indicators', () => {
    it('should show online status', () => {
      ...
      const badge = getBadgeElement('Online');
    ...
    it('should show offline status', () => {
      ...
      const badge = getBadgeElement('Offline');
    ...
    it('should show busy status', () => {
      ...
      const badge = getBadgeElement('Busy');
    ...
    it('should show away status', () => {
      ...
      const badge = getBadgeElement('Away');
  ...
  describe('Responsive Design', () => {
    it('should support responsive size classes', () => {
      ...
      const badge = getBadgeElement('Responsive Badge');
      expect(badge).toHaveAttribute('data-size', 'sm');
    ...
    it('should support responsive variant classes', () => {
      ...
      const badge = getBadgeElement('Responsive Variant Badge');
      expect(badge).toHaveAttribute('data-variant', 'outline');
  ...
  describe('Animation and Transitions', () => {
    it('should support pulse animation', () => {
      ...
      const badge = getBadgeElement('Pulsing Badge');
    ...
    it('should support bounce animation', () => {
      ...
      const badge = getBadgeElement('Bouncing Badge');
    ...
    it('should support fade animation', () => {
      ...
      const badge = getBadgeElement('Fading Badge');
  ...
  describe('Custom Content', () => {
    ...
    it('should support HTML elements as children', () => {
      ...
      const badge = getBadgeElement('Bold Text');
      expect(badge).toBeInTheDocument();
  ...
  describe('Performance Considerations', () => {
    it('should handle rapid updates efficiently', () => {
      ...
      const badge = getBadgeElement('100');
      expect(badge).toBeInTheDocument();
    });
    ...
    it('should handle large numbers with max display', () => {
      ...
      const badge = getBadgeElement('999+');
      expect(badge).toBeInTheDocument();
    });
  });
  ...
  describe('Common Use Cases', () => {
    ...
    it('should work as a category label', () => {
      ...
      const badge = getBadgeElement('Category');
      expect(badge).toHaveAttribute('data-variant', 'outline');
    });
