...
const mockNotes: Note[] = [
  {
    ...
    content:
      '本文档介绍了React Hooks的最佳实践，包括useState、useEffect、useContext等常用Hooks的使用方法和注意事项。通过实际案例展示了如何正确使用Hooks来构建高效、可维护的React应用。',
  ...
  },
  {
    ...
    content:
      'TypeScript的类型系统非常强大，本文档深入探讨了泛型、条件类型、映射类型等高级特性。通过实际项目示例展示了如何利用TypeScript的类型系统来提升代码质量和开发效率。',
  ...
  },
  {
    ...
    content:
      'CSS Grid是一个强大的二维布局系统，本文档全面介绍了Grid布局的各种属性和使用场景。从基础概念到高级技巧，帮助开发者掌握现代CSS布局技术。',
  ...
  },
  {
    ...
    title: 'Node.js性能优化技巧',
    content:
      'Node.js应用性能优化是一个重要话题，本文档介绍了内存管理、异步处理、缓存策略等优化技巧。通过实际案例展示了如何诊断和解决常见的性能问题。',
  ...
  },
  {
    ...
    title: 'AI驱动的智能搜索实现',
    content:
      '现代搜索引擎越来越多地使用AI技术来提升搜索结果的相关性和用户体验。本文档探讨了自然语言处理、向量搜索、推荐算法等AI技术在搜索系统中的应用。',
  ...
  },
  {
    ...
    title: '前端性能监控方案',
    content:
      '本文档介绍了完整的前端性能监控方案，包括性能指标收集、实时监控、性能分析工具等。通过建立完善的性能监控体系，帮助团队及时发现和解决性能问题。',
  ...
  },
  {
    ...
    title: '微服务架构设计模式',
    content:
      '微服务架构是现代分布式系统的重要设计模式。本文档详细介绍了微服务的设计原则、通信机制、数据管理、服务发现等核心概念，以及常见的架构模式和最佳实践。',
  ...
  },
  {
    ...
    title: '数据库查询优化实践',
    content:
      '数据库性能优化是后端开发的重要技能。本文档从索引设计、查询优化、执行计划分析等方面，详细介绍了数据库性能优化的各种技巧和工具。',
