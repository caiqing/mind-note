...
const mockRecentNotes: Note[] = [
  {
    ...
    content:
      '本文档介绍了React Hooks的最佳实践，包括useState、useEffect、useContext等常用Hooks的使用方法和注意事项...',
  ...
  },
  {
    ...
    content:
      'TypeScript的类型系统非常强大，本文档深入探讨了泛型、条件类型、映射类型等高级特性...',
  ...
  },
  {
    ...
    content:
      'CSS Grid是一个强大的二维布局系统，本文档全面介绍了Grid布局的各种属性和使用场景...',
  ...
  },
  {
    ...
    title: 'Node.js性能优化技巧',
    content:
      'Node.js应用性能优化是一个重要话题，本文档介绍了内存管理、异步处理、缓存策略等优化技巧...',
  ...
  },
  {
    ...
    title: 'AI驱动的智能搜索实现',
    content:
      '现代搜索引擎越来越多地使用AI技术来提升搜索结果的相关性和用户体验...',
